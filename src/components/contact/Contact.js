...
const Contact = () => {
  ...
  const handleSend = (e) => {
    ...
    if (clientName && email && EmailValidation(email) && messages) {
      axios.post("https://getform.io/f/bxojrkra", {
        name: clientName,
        email: email,
        message: messages,
      });
  ...
  return (
    <div className="w-full">
      ...
      <div className="w-full lgl:w-1/2">
        <p className="flex gap-6 justify-between w-full text-base text-[#ccc] py-2 border-b-[1px] border-b-zinc-800">
        ...
        <p className="flex justify-between w-full text-base text-[#ccc] py-2 border-b-[1px] border-b-zinc-800">
          <span className="bg-designColor text-gray-700 text-xs font-titleFont font-medium px-2 rounded-md flex items-center justify-center">
            Phone:
          </span>
          +91 9994706307
      ...
      <div className="w-full lgl:w-1/2">
        <p className="flex justify-between lgl:gap-6 w-full text-base text-[#ccc] py-2 border-b-[1px] border-b-zinc-800">
          <span className="bg-designColor text-gray-700 text-xs font-titleFont font-medium px-2 rounded-md flex items-center justify-center">
            Email:
          </span>
          ramkumar.vallimayil@gmail.com
        </p>
        <p className="flex justify-between w-full text-base text-[#ccc] py-2 border-b-[1px] border-b-zinc-800">
          <span className="bg-designColor text-gray-700 text-xs font-titleFont font-medium px-2 rounded-md flex items-center justify-center">
            Freelance:
      ...
      <div className="w-full mt-10">
        ...
        {seuccessMsg ? (
          ...
          <form
            id="form"
            action="https://getform.io/f/bxojrkra"
            method="POST"
